...
with open (r"E:\Helen\FinalProject_INFO5731\COVID_19_relatedWorking\All_COVID_related_body_DS\COVID19_AllRelated_bodyText_DSApr17.csv", 'w', newline='', encoding='utf-8') as file:
