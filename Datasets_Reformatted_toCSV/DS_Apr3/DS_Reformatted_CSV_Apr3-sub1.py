...
import tarfile
'''
my_tar = tarfile.open("E:\Helen\FinalProject_INFO5731\All_DS_CORD19\DS_CORD19_1st\pmc_custom_license.tar.gz")
my_tar.extractall(
    "E:\Helen\FinalProject_INFO5731\All_DS_CORD19\DS_CORD19_1st\DS_extracted")  # specify which folder to extract to
my_tar.close()
...
#first dir
dir1 = "E:\Helen\FinalProject_INFO5731\All_DS_CORD19\DS_CORD19_April3\DS_extracted\iorxiv_medrxiv\pdf_json"
filenames1 = os.listdir(dir1)
print("Number of articles retrieved from :", len(filenames1))
'''
#Second dir
dir2 = r"E:\Helen\FinalProject_INFO5731\All_DS_CORD19\DS_CORD19_April3\DS_extracted\comm_use_subset\pmc_json"
...
with open(r"E:\Helen\FinalProject_INFO5731\done_for_storing\DS_Apr2_reformatted\reformatted_biorxiv_medrxiv.csv", "w", newline="",
