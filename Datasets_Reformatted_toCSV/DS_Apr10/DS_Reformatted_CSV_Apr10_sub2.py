...
import tarfile
'''
my_tar = tarfile.open("E:\Helen\FinalProject_INFO5731\All_DS_CORD19\DS_CORD19_April10\oncomm_use_subset.tar.gz")
my_tar.extractall("E:\Helen\FinalProject_INFO5731\All_DS_CORD19\DS_CORD19_April10\DS_extracted")  # specify which folder to extract to
my_tar.close()
'''
...
dir1 = "E:\Helen\FinalProject_INFO5731\All_DS_CORD19\DS_CORD19_April10\DS_extracted\oncomm_use_subset\pdf_json"
filenames1 = os.listdir(dir1)
print("Number of articles retrieved from :", len(filenames1))

dir2 = "E:\Helen\FinalProject_INFO5731\All_DS_CORD19\DS_CORD19_April10\DS_extracted\oncomm_use_subset\pmc_json"
...
with open(r"E:\Helen\FinalProject_INFO5731\CSV_formatted\DS_Apr10_reformatted\reformatted_noncomm_use_subset.csv", "w", newline="",
