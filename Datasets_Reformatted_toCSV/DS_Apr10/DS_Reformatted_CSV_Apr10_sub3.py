...
import tarfile
'''
my_tar = tarfile.open("E:\Helen\FinalProject_INFO5731\All_DS_CORD19\DS_CORD19_April10\custom_license.tar.gz")
...
dir1 = "E:\Helen\FinalProject_INFO5731\All_DS_CORD19\DS_CORD19_April10\DS_extracted\custom_license\pdf_json"
filenames1 = os.listdir(dir1)
print("Number of articles retrieved from :", len(filenames1))

dir2 = "E:\Helen\FinalProject_INFO5731\All_DS_CORD19\DS_CORD19_April10\DS_extracted\custom_license\pmc_json"
...
with open(r"E:\Helen\FinalProject_INFO5731\CSV_formatted\DS_Apr10_reformatted\reformatted_custom_license.csv", "w", newline="",
