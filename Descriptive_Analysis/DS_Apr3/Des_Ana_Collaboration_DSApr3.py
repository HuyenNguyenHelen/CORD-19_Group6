...
with open (r"E:\Helen\FinalProject_INFO5731\ALL_OUTPUTS\DS_Apr3\Descriptive_analysis\collaborations_list_DSApr3.csv", 'w',  newline="",
...
with open (r"E:\Helen\FinalProject_INFO5731\ALL_OUTPUTS\DS_Apr3\Descriptive_analysis\collaborations_ranked_DSApr3.csv", 'w',  newline="",
           encoding='utf-8') as file:
    colla_ranked.to_csv(file)
colla_ranked_top = {k :v for k ,v in hist.items() if k!= '' and v >= 25}
...
obmitted = ['inc west point pennsylvania crucell nv leiden', 'merck research laboratories merck  company',
            'instituto de salud carlos iii', 'las palmas de gran canaria']
for tup in collaboration:
...
nx.draw(G, pos, node_size=size_list, node_color='blue', width=1, edge_cmap=plt.cm.Blues, with_labels=False)
nx.draw_networkx_labels(G, pos, labels, font_size=6, font_color='yellow')

plt.axis('off')
plt.title('Colaboration Network', size=17)
fig.savefig(r"E:\Helen\FinalProject_INFO5731\ALL_OUTPUTS\DS_Apr3\Descriptive_analysis\Collaboration_network_DSApr3.jpg",
