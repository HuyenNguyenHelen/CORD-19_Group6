...
fig.savefig("E:\Helen\FinalProject_INFO5731\ALL_OUTPUTS\DS_1st\Descriptive_analysis\institutions_wordcloud_DS1.jpg", bbox_inches='tight', dpi=200)
plt.show()
...
with open (r"E:\PycharmProjects\COVID-19\DATASET_OUTPUT\ALL_OUTPUTS\DS_1st\Descriptive_analysis\institution_frequency.csv", 'w',  newline="",
          encoding='utf-8') as file:
    rank_affi.to_csv(file)
'''
institutions = [k for k, v in auth_inst_sorted.items() if v >= 70]
frequency = [v for k, v in auth_inst_sorted.items() if v >= 70]
...
fig.savefig(r"E:\Helen\FinalProject_INFO5731\ALL_OUTPUTS\DS_1st\Descriptive_analysis\Top_authorname_DS1.jpg", bbox_inches='tight', dpi=200)
plt.show()
'''