...
with open (r"E:\Helen\FinalProject_INFO5731\ALL_OUTPUTS\DS_1st\Descriptive_analysis\Journals_frequency.csv", 'w',  newline="",
...
fig.savefig(r"E:\Helen\FinalProject_INFO5731\ALL_OUTPUTS\DS_1st\Descriptive_analysis\Top Most Published Journals_DS1.jpg", bbox_inches='tight', dpi=200)
...
with open (r"E:\Helen\FinalProject_INFO5731\ALL_OUTPUTS\DS_1st\Descriptive_analysis\Journals_overYears.csv", 'w',  newline="",
          encoding='utf-8') as file:
...
fig.savefig(r"E:\Helen\FinalProject_INFO5731\ALL_OUTPUTS\DS_1st\Descriptive_analysis\Papers over Years.jpg", bbox_inches='tight', dpi=200)
plt.show()
'''