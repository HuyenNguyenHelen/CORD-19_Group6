...
with open (r"E:\Helen\FinalProject_INFO5731\ALL_OUTPUTS\DS_Apr17\Descriptive_Analysis\institution_frequency_DSApr17.csv", 'w',  newline="",
          encoding='utf-8') as file:
    rank_affi.to_csv(file)

institutions = [k for k, v in auth_inst_sorted.items() if v >= 187]
frequency = [v for k, v in auth_inst_sorted.items() if v >= 187]
...
plt.ylabel('Institutions',fontsize=7)
#plt.title("Top Affiliations", fontsize=20)
fig.savefig(r"E:\Helen\FinalProject_INFO5731\ALL_OUTPUTS\DS_Apr17\Descriptive_Analysis\Top_institutions_DSApr17.jpg", bbox_inches='tight', dpi=200)
plt.show()
